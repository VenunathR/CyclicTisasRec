...
PeriodicPositionalBias (separate w_sin_K, w_cos_K, w_sin_V, w_cos_V).
...
def build_param_groups(
    ...
    bias_params = list(model.cyclic_bias.parameters())
...
def main3() -> None:
    ...
    param_groups = build_param_groups(
        model if not args.compile else model._orig_mod,  # type: ignore[attr-defined]
